...
/** This is the DARE implemented in the Drake library (https://github.com/RobotLocomotion/drake)
 * It gives nearly identical results to my initial implementation and both give very comparable results
 * to the Matlab equivalent of the LQR solution.
 */
